...
# Load the trained metal detection model
model = load_model(r'C:\Users\Gandhiraj\PycharmProjects\Ocean-RoobAi\backend\metal_detector_model.h5')
...
while True:
    ...
    label = 'Not Metal' if prediction[0][0] > 0.5 else ' Metal'
